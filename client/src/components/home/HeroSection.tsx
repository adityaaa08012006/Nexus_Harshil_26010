...
export default function HeroSection() {
  ...
  return (
    <section
      ...
      style={{
        background: 'linear-gradient(135deg, #0f1419 0%, #162415 25%, #25671E 55%, #1a2e1a 85%, #0f1419 100%)',
      }}
    >
      {/* Subtle grid pattern */}
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-32">
        <div className="text-center space-y-8">
          ...
          >
            ...
            <span className="text-godam-leaf font-semibold">AI-powered optimization</span>.
            Monitor conditions in real-time, predict spoilage, and reduce waste by{' '}
            <span className="text-godam-sun font-semibold">20%</span>.
          </p>
            ...
            {[
              ...
              >
                ...
                <div className="text-left">
                  <div className="text-white font-semibold text-sm leading-tight">{pill.label}</div>

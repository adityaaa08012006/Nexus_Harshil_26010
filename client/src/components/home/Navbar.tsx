        ...
        <div className="flex items-center justify-between h-16">
          ...
          >
            ...
            <div className="flex flex-col">
              <span className={`font-heading font-bold text-lg transition-colors duration-300 ${isScrolled ? 'text-godam-forest' : 'text-white'}`}>
                Godam Solutions
              </span>
              <span className={`text-[10px] font-medium uppercase tracking-[0.15em] transition-colors duration-300 ${isScrolled ? 'text-godam-leaf' : 'text-godam-sun'}`}>
          ...
          >
            <svg className={`w-5 h-5 transition-colors ${isScrolled ? 'text-godam-forest' : 'text-white'}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
              {isMobileMenuOpen ? (
      ...
      >
        <div className="bg-white/95 backdrop-blur-xl border-t border-gray-100 px-4 py-6 space-y-1 shadow-xl">
          ...
          <div className="pt-4 border-t border-gray-100 space-y-2">
            <Link to="/login" className="block w-full text-center px-4 py-3 text-godam-forest font-semibold rounded-xl hover:bg-godam-forest/5 transition-all">
              Sign In
            </Link>
            <Link to="/login" className="block w-full text-center px-4 py-3 bg-gradient-to-r from-godam-forest to-godam-leaf text-white font-semibold rounded-xl shadow-godam">
              Get Started
            </Link>
          </div>
        </div>

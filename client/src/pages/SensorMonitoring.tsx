...
export const SensorMonitoring: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-green-50/30 p-3 sm:p-6">
      <div className="max-w-7xl mx-auto">
        {/* Header */}
        <div className="bg-white rounded-xl shadow-md border border-gray-100 p-4 sm:p-6 mb-4 sm:mb-6 hover:shadow-lg transition-shadow">
          {/* Title Section */}
          <div className="flex items-start sm:items-center gap-3 sm:gap-4 mb-4">
            <div className="p-2 sm:p-3 bg-gradient-to-br from-godam-leaf/20 to-godam-forest/20 rounded-xl border border-godam-leaf/30 shrink-0">
              <Activity className="w-5 h-5 sm:w-6 sm:h-6 text-godam-forest" />
            </div>
          ...
          <div className="flex flex-col sm:flex-row gap-2 sm:gap-3 mb-4">
            ...
            {user?.role === "owner" && warehouses.length > 0 && (
              <select
                ...
                className="w-full sm:w-auto px-3 sm:px-4 py-2.5 sm:py-2 text-xs sm:text-sm border-2 rounded-lg focus:outline-none focus:ring-2 focus:ring-godam-leaf bg-white font-medium shadow-sm hover:shadow transition-shadow"
                style={
                  {
                    borderColor: "#E5E7EB",
            ...
            <div className="grid grid-cols-2 sm:flex gap-2 sm:gap-3">
              ...
              <button
                ...
                className="flex items-center justify-center gap-1.5 sm:gap-2 px-3 sm:px-4 py-2.5 sm:py-2 bg-purple-600 text-white rounded-lg hover:bg-purple-700 hover:shadow-md transition-all disabled:opacity-50 disabled:cursor-not-allowed shadow-sm text-xs sm:text-sm font-medium"
              >
                <Activity
                  className={`w-3.5 h-3.5 sm:w-4 sm:h-4 ${isSimulating ? "animate-pulse" : ""}`}
                />
              ...
              <button
                ...
                className="flex items-center justify-center gap-1.5 sm:gap-2 px-3 sm:px-4 py-2.5 sm:py-2 bg-white border-2 border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 hover:shadow-sm transition-all disabled:opacity-50 text-xs sm:text-sm font-medium"
              >
                <RefreshCw
              ...
              <button
                ...
                className="flex items-center justify-center gap-1.5 sm:gap-2 px-3 sm:px-4 py-2.5 sm:py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 hover:shadow-md transition-all disabled:opacity-50 disabled:cursor-not-allowed shadow-sm text-xs sm:text-sm font-medium"
              >
              ...
              <button
                ...
                className="flex items-center justify-center gap-1.5 sm:gap-2 px-3 sm:px-4 py-2.5 sm:py-2 text-white rounded-lg transition-all hover:shadow-md shadow-sm text-xs sm:text-sm font-medium"
            ...
            {availableZones.map((zone) => {
              ...
              return (
                <button
                  ...
                  className={`sm:flex-1 px-3 sm:px-4 py-2.5 sm:py-3 rounded-lg text-xs sm:text-sm font-semibold transition-all relative ${
                    selectedZone === zone
                      ? "bg-green-600 text-white shadow-md"
                      : "bg-white text-gray-700 border border-gray-200 hover:bg-gray-50"
                  }`}
                >
                  <span className="truncate block">{zone}</span>
                  {hasAlert && (
                ...
                <div className="space-y-2">
                  {alerts
                    ...
                    .map((alert) => (
                      <div
                        key={alert.id}
                        className="bg-white rounded-lg p-2.5 sm:p-3 border border-red-200"
                      >

...
export const OwnerDashboard: React.FC = () => {
  ...
  return (
    <div className="space-y-6 pb-6 min-h-screen bg-gradient-to-br from-gray-50 to-green-50/30">
      {/* ── Page header with tabs ── */}
      <div className="bg-white rounded-xl border border-gray-100 shadow-md">
        <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-4 p-6 border-b border-gray-100 bg-gradient-to-r from-godam-forest/5 to-transparent">
          <div>
        ...
        <div className="flex border-b border-gray-200">
          <button
            ...
            className={`px-6 py-3 text-sm font-semibold border-b-2 transition-all ${
              activeView === "overview"
                ? "border-godam-leaf text-godam-leaf bg-godam-leaf/5"
                : "border-transparent text-gray-500 hover:text-godam-forest hover:bg-gray-50"
            }`}
          >
            Overview
          </button>
